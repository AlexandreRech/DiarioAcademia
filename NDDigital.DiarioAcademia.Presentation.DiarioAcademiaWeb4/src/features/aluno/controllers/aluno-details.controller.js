/* @ngInject */
module.exports = function alunoDetailsController(alunoService, turmaService, $stateParams, $state, $scope, cepService, $translate, SweetAlert) {
    var vm = this;
    ...
    function activate() {
        turmaService.getTurmas().then(function (dataTurmas) {
            alunoService.getAlunoById($stateParams.alunoId).then(function (result) {
