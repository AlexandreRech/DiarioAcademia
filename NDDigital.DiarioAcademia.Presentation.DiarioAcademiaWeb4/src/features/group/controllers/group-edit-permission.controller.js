/* @ngInject */
module.exports = function groupPermissionEditController(groupService, authoService, claimService, authoUtilFactory,
        $state, $stateParams, changesFactory, $translate, SweetAlert) {
